...
const uz = {
  ...
  "login.shopCodeHint": "Odatda kerak emas — login o'zi do'konni aniqlaydi.",
  "login.useShopCode": "Do'kon kodi bilan kirish",
  "login.takenOver": "Hisobingizga boshqa qurilmadan kirildi va bu sessiya tugatildi. Davom etish uchun qaytadan kiring.",
  "login.otherAccount": "Boshqa hisob",
  "login.login": "Login",
...
const ru = {
  ...
  "login.shopCodeHint": "Обычно не нужен — логин сам определяет магазин.",
  "login.useShopCode": "Войти с кодом магазина",
  "login.takenOver": "В ваш аккаунт вошли с другого устройства, эта сессия завершена. Войдите заново, чтобы продолжить.",
...
const en = {
  ...
  "login.shopCodeHint": "Usually not needed — the login identifies the shop.",
  "login.useShopCode": "Sign in with a shop code",
  "login.takenOver": "Your account was signed in on another device and this session ended. Sign in again to continue.",
